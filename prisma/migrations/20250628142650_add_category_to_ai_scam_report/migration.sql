/*
  ...
  - You are about to drop the column `title` on the `AIScamReport` table. All the data in the column will be lost.
  - You are about to drop the column `category` on the `ScamReport` table. All the data in the column will be lost.
  - Added the required column `category` to the `AIScamReport` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_AIScamReport" ("averageFinancialImpact", "averageRiskLevel", "createdAt", "id", "summary", "updatedAt") SELECT "averageFinancialImpact", "averageRiskLevel", "createdAt", "id", "summary", "updatedAt" FROM "AIScamReport";
